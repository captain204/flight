...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{url('Test/css/font-awesome.css')}}"/>
    <link rel="stylesheet" href="{{url('Test/css/lineicons.css')}}"/>
    <link rel="stylesheet" href="{{url('Test/css/weather-icons.css')}}"/>
    <link rel="stylesheet" href="{{url('Test/css/bootstrap.css')}}"/>
    <link rel="stylesheet" href="{{url('Test/css/styles.css')}}"/>
  </head>
  <body>
        ...
        <div class="navbar-inner nav">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">
              <img src="{{url('Test/img/logo.png')}}" alt="Image Alternative text" title="Image Title"/>
            </a>
          </div>
                    ...
                    <div class="row">
                        ...
                        <form action="{{route('flight')}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="adult" class="form-control" placeholder="Number of Adults Above 12">
                                </div>
                                <div class="form-group">
                                    <label for="children">Children</label>
                                    <input type="number" name="children" class="form-control" placeholder="Number of children between ages 2 and 12">
                                </div>
                                <div class="form-group">
                                    <label for="infants">Infants</label>
                                    <input type="number" name="infants" class="form-control" placeholder="Number of infants between ages 0 and 2">
                                </div>
    ...
    <script src="{{url('Test/js/jquery.js')}}"></script>
    <script src="{{url('Test/js/moment.js')}}"></script>
    <script src="{{url('Test/js/bootstrap.js')}}"></script>
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDYeBBmgAkyAN_QKjAVOiP_kWZ_eQdadeI&callback=initMap&libraries=places"></script>
    <script src="{{url('Test/js/owl-carousel.js')}}"></script>
    <script src="{{url('Test/js/blur-area.js')}}"></script>
    <script src="{{url('Test/js/icheck.js')}}"></script>
    <script src="{{url('Test/js/gmap.js')}}"></script>
    <script src="{{url('Test/js/magnific-popup.js')}}"></script>
    <script src="{{url('Test/js/ion-range-slider.js')}}"></script>
    <script src="{{url('Test/js/sticky-kit.js')}}"></script>
    <script src="{{url('Test/js/smooth-scroll.js')}}"></script>
    <script src="{{url('Test/js/fotorama.js')}}"></script>
    <script src="{{url('Test/js/bs-datepicker.js')}}"></script>
    <script src="{{url('Test/js/typeahead.js')}}"></script>
    <script src="{{url('Test/js/quantity-selector.js')}}"></script>
    <script src="{{url('Test/js/countdown.js')}}"></script>
    <script src="{{url('Test/js/window-scroll-action.js')}}"></script>
    <script src="{{url('Test/js/fitvid.js')}}"></script>
    <script src="{{url('Test/js/youtube-bg.js')}}"></script>
    <script src="{{url('Test/js/custom.js')}}"></script>
  </body>
</html>